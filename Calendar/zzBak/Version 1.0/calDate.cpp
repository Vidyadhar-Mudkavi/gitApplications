/**
  ...
  *Description:
   ...
   this file implements the class calDate
...
// const declarations
const char* calDate_id = 
   "@(#) calDate. implementation. ver. 1.0. Premalatha, Vidyadhar Mudkavi, CTFD, NAL.";
// function prototypes
...
/**
  ...
  */
calDate::calDate(const calDate& class_var)
{
}
...
calDate& calDate::operator=(const calDate& class_var)
{
   return *this;
}
