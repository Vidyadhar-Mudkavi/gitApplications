...
/**
  ...
  */
int calFn::KDayBefore(const calRataDie<int>& rd, int k)
{
...
/**
  ...
  * Inputs are fixed date and weekday.
  */
int calFn::KDayAfter(const calRataDie<int>& rd, int k)
{
...
/**
  ...
  * Inputs are fixed date and weekday.
  */
int calFn::KDayOnOrBefore(const calRataDie<int>& rd, int k)
{
...
/**
  ...
  */
int calFn::DayOfWeekFromFixed(const calRataDie<int>& date)
{
...
/**
  ...
  * k-day of 0 means sunday, 1 means monday and so on.
  */
int calFn::NthKDay(int n, int k, const calGregorian<int>& g_date)
{
   if (n > 0)
   {
