...
// begin application
   ...
   // test assignment, special construction etc.
      ...
      calGregorian<int> g_ep( g_ep_dt );

      calRataDie<int> rd_g_ep = g_ep.Fixed();
...
#if 0 // presently turn off testing of other calendars when converting to templates.
