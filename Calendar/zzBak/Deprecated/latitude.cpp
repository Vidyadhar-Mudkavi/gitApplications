/**
  ...
  *Description:
   ...
   this file implements the class latitude
...
// const declarations
const char* latitude_id = 
   "@(#) latitude. implementation. ver. 1.0. Premalatha, Vidyadhar Mudkavi, CTFD, NAL.";
// function prototypes
...
/**
  ...
  */
latitude::latitude(const latitude& class_var)
{
}
...
latitude& latitude::operator=(const latitude& class_var)
{
   return *this;
}
